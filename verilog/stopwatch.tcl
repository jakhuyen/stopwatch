# Run cdStopwatch first to set the correct directory
...
# Create project
create_project -part xc7a100tcsg324-1 stopwatch $outputdir -force
...
set_property PROGRAM.FILE {C:/Users/Jak/win_shared/projs/stopwatch/verilog/synthesis/stopwatch.runs/impl_1/stopwatch.bit} [lindex [get_hw_devices] 0]
...
# "source stopwatch.tcl" will run this script. -notrace will stop the command line from displaying the TCL code